...
function App() {
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-800 grid place-content-center">
      ...
      <div className="w-[350px] h-[590px] p-1 rounded-3xl shadow-2xl">
        {/* Card */}
        <div className="w-full h-full cursor-pointer group perspective">
          <div className="relative w-full h-full duration-500 preserve-3d group-hover:rotate-y-180">
            {/* Front Side */}
            <div className="absolute w-full h-full bg-gradient-to-r from-purple-700 via-pink-600 to-yellow-500 p-1 rounded-3xl shadow-2xl overflow-hidden backface-hidden duration-500">
            ...
            {/* backside */}
            <div className="absolute w-full h-full bg-gradient-to-r from-purple-700 via-pink-600 to-yellow-500 p-1 rounded-3xl shadow-2xl overflow-hidden backface-hidden rotate-y-180 duration-500">
              <div
                className="w-full h-full rounded-2xl overflow-hidden p-10 text-neutral-50 space-y-5"
